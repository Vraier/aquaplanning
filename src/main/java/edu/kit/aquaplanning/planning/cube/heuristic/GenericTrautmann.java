...
public class GenericTrautmann extends GenericHeuristic{
	...
	public int value(GenericSearchNode node) {
		...
		List<Atom> goal = newGoal.getPositiveAtoms();
