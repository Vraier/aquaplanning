...
public class BBackwardSearchNode extends GenericSearchNode {

	public AtomSet trueAtoms;
	public AtomSet falseAtoms;

	public BBackwardSearchNode(GroundPlanningProblem problem) {
		this.depth = 0;
		this.parent = null;
	 ...
	 */
	private BBackwardSearchNode(BBackwardSearchNode parent, Action action) {
	...
	public List<GenericSearchNode> getPredecessors() {
		...
		for (Action a : problem.getActions()) {
			if (canApplyTo(a)) {
				list.add(new BBackwardSearchNode(this, a));
			}
		}
		return list;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BBackwardSearchNode other = (BBackwardSearchNode) obj;
		if (falseAtoms == null) {
