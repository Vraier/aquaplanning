...
commandLists = [maxSeconds, plannerType, numThreads, verbosityLevel, numCubes, cubeFindDescents, cubeNodeType, cubeFinderMode, cubeFindSearchStrategy, schedulerMode, schedulerTime, exponentialGrowth]
