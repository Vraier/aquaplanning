...
for folder in os.listdir(os.path.join(homeDirName, 'result')):
    currPath = os.path.join(homeDirName, 'result', folder)
    testFilePath = os.path.join(homeDirName, 'allFiles', folder)
    filteredPath = os.path.join(homeDirName, 'filtered', folder)
